...
<head>
    ...
    <title>Logged Session Notification</title>
</head>
                ...
                <table width="680" style="padding: 20px;">
                    ...
                    <tr>
                        <td style="background-color: #fff; display: block; padding: 25px;">
                            ...
                            <!-- Body -->
                            <p> {{ $payload["currentUser"] }} has logged your {{ $payload["sessionDuration"] }} hour session held on {{ $payload["sessionDate"] }}.
                            Click <a href="https://{{ $payload["sessionUrl"] }}">here</a> to confirm the session
                            </p>
