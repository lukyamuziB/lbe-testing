...
<head>
    ...
    <title>Select Mentor Reminder</title>
                    ...
                    <tr>
                        <td style="background-color: #fff; display: block; padding: 25px;">
                            ...
                            <table style="border-bottom: 1px solid #eee; padding: 5px; padding-bottom: 35px; vertical-align:top; width: 100%;">
                                <tbody>
                                    <p>Your Request with title <b>{{ $requestTitle }}</b> has mentor(s)  who have indicated interest in mentoring you.</p>
                                    <p>Click <a href="https://{{$requestUrl}}"> Here </a> to visit</p>
                                </tbody>
                            </table>
