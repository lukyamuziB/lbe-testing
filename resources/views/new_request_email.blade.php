                ...
                <table width="680" style="padding: 20px;">
                    ...
                    <tr>
                        <td style="background-color: #fff; display: block; padding: 25px;">
                            ...
                            <!-- Body -->
                            <p> {{ $payload["currentUser"] }} has created a request to be mentored in {{ $payload["title"] }} . Click <a href="https://{{ $payload["requestUrl"] }}">here</a> to indicate interest in this request.</p>
                            <!-- Body -->
