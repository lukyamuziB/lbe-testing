...
<head>
    ...
    <title>Inactive Mentorship Notification</title>
</head>
                    ...
                    <tr>
                        <td style="background-color: #fff; display: block; padding: 25px;">
                                                        ...
                                                        <tr>
                                                            <th width="300">
                                                                <h3 style="color: #fff; font-weight: 50; text-align: left; font-size: 15px">
                                                                    Inactive Mentorship Notification
                                                                </h3>
                                                            </th>
                                                        </tr>
                                                        </tbody>
                            ...
                            <p>Dear Fellow
                                ...
                                <p>We have noticed that you have not logged sessions in a while. We would like to know if these mentorship sessions have been held so we can update necessary records; like logging your hours for you on Freckle, alongside other activities.

                                <p>Kindly update the sessions on lenken. You may speak with your mentor/mentee to also update theirs.<p>

                                <p>If these sessions have not been held, please send a message to mentorshiprequests@andela.com with the subject "Inactive Sessions" and let us know.<p>
