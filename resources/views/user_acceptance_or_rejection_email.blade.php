...
<head>
    ...
    <title>{{$payload["notificationType"] === "accept_user" ?  "Accepted" : "Rejected" }} {{ $payload["userRole"] }} Notification</title>
</head>
                ...
                <table width="680" style="padding: 20px;">
                    ...
                    <tr>
                        <td style="background-color: #fff; display: block; padding: 25px;">
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <th width="300">
                                                                ...
                                                                {{$payload["notificationType"] === "accept_user" ?  "Accepted" : "Rejected" }} {{$payload["userRole"]}} Notification
                                                                </h3>
                                                            </th>
                                                        </tr>
                                                        </tbody>
                            ...
                            <!-- Body -->
                            @if( $payload["notificationType"] === "accept_user")
                            <p> Congratulations! {{ $payload["fullname"] }} has accepted you as their {{ $payload["requestedSkill"] }} {{ lcfirst($payload["userRole"]) }}.</p>
                           @else
                           <p> {{ $payload["fullname"] }} opted to go with a different {{ $payload["requestedSkill"] }} {{ lcfirst($payload["userRole"]) }}.</p>
                            @endif
                             <!-- Body -->
